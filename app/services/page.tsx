...
const services = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1577563908411-5077b6dc7624?auto=format&fit=crop&q=80&w=800",
  },
  {
    id: 9,
    ...
    image:
      "https://images.unsplash.com/photo-1615651951235-fd501c36e271?auto=format&fit=crop&q=80&w=800",
  },
];
interface Service {
  id: number;
      ...
      >
        <div className="p-8">
          <div className="flex items-center gap-4 mb-6">
            {service.icon}
            <h3 className="text-3xl font-bold text-indigo-950">
              {service.title}
            </h3>
          </div>
