...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="section-container bg-gradient-to-b from-indigo-50 to-white relative overflow-hidden"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-indigo-950/80 max-w-2xl">
              An advertising company emerged to address the fragmented nature of
              online advertising services. We offer a comprehensive suite of
              marketing and promotional services under one roof.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <button
                className="px-8 py-3 rounded-full border-2 border-indigo-600 text-indigo-600 font-semibold hover:bg-indigo-50 transition-all duration-300"
