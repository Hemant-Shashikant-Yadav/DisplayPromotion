...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-gradient-to-b from-white to-sky-100 py-16"
    >
        ...
        <div className="grid md:grid-cols-3 gap-12 text-sky-950">
          <div className="space-y-4">
            ...
            <p className="text-sky-900/80 leading-relaxed">
              ...
              prime choice for professional growth and digital excellence.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                href="mailto:info@displaypromotions.com"
              ...
              <div className="flex items-center gap-2 text-sky-900/80">
                ...
                AIP Katphal Tel. Baramati, Dist. Pune.
              </div>
            </div>
          </div>
